  ...
  <div id="app">
    ...
    <aside id="sidebar">
      ...
      <div class="sb-section">
        ...
        <a class="sb-item active" href="compare.php"><span class="sb-icon"><svg width="15" height="15"
    ...
    <div id="main">
      ...
      <div class="content">
        ...
        <div class="card chart-card" style="padding:1.25rem 1.5rem">
          <h3>Category Comparison</h3>
          <div class="cw md"><canvas id="cmp-chart"></canvas></div>
        </div>
