...
<title>Compare — CyberShield</title>
...
<a class="sb-item" href="settings.php"><span class="sb-icon"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="4"/><path d="M6 20v-2a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v2"/></svg></span><span class="sb-text">Settings</span></a>
      ...
      <a class="sb-item active" href="compare.php"><span class="sb-icon"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="8" x2="6" y2="8"/><line x1="21" y1="16" x2="3" y2="16"/></svg></span><span class="sb-text">Compare</span></a>
  ...
  <div id="main">
    ...
    <div class="topbar">
      ...
      <div class="tb-right">
        ...
        <div class="tb-divider"></div>
        <a class="tb-admin" href="settings.html">
...
<div class="sec-hdr"><h2>Compare Vendors</h2><p>Side-by-side risk analysis across all categories.</p></div>
<div class="card" style="padding:1.5rem;margin-bottom:1.25rem">
  <div style="display:grid;grid-template-columns:1fr auto 1fr;gap:1.25rem;align-items:center;margin-bottom:1.25rem">
    <div><label class="fl">Vendor A</label><select class="fsel" id="cmp-a" onchange="renderCmp()" style="width:100%;padding:.52rem .85rem;border-radius:8px"></select></div>
    <div style="font-family:var(--display);font-size:1.3rem;letter-spacing:2px;text-align:center;color:var(--muted)">VS</div>
    <div><label class="fl">Vendor B</label><select class="fsel" id="cmp-b" onchange="renderCmp()" style="width:100%;padding:.52rem .85rem;border-radius:8px"></select></div>
  </div>
  <div id="cmp-result"></div>
</div>
<div class="card chart-card" style="padding:1.25rem 1.5rem"><h3>Category Comparison</h3><div class="cw md"><canvas id="cmp-chart"></canvas></div></div>
