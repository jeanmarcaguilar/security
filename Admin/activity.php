...
<div class="sec-hdr"><h2>Activity Log</h2><p>History of all admin actions and system events.</p></div>
<div class="card" style="padding:1.25rem 1.5rem">
  <div class="tbl-bar" style="margin-bottom:.9rem">
    <h3>Recent Activity</h3>
    <div class="frow">
      <select class="fsel" id="act-f" onchange="renderAct()"><option value="">All Events</option><option value="export">Export</option><option value="flag">Flag</option><option value="refresh">Refresh</option><option value="alert">Alert</option><option value="profile">Profile</option></select>
