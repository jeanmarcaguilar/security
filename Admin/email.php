      ...
      <div class="content">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:1.25rem">
          <div class="card" style="padding:1.5rem">
            ...
            <div class="fg"><label class="fl">Subject</label><input class="fi" type="text" id="em-sub"
                value="CyberShield Risk Assessment Report" oninput="updatePreview()" /></div>
            <div class="fg"><label class="fl">Additional Note (optional)</label><textarea class="fi" id="em-note"
                rows="3" placeholder="Add a personal message…" oninput="updatePreview()"></textarea></div>
          ...
          <div>
            <div class="card" style="padding:1.5rem;margin-bottom:1.25rem">
              <h3
                ...
                Email Preview</h3>
              <div id="em-preview"
                style="background:rgba(255,255,255,.03);border:1px solid var(--border);border-radius:8px;padding:1rem;font-size:.8rem;color:var(--muted2);min-height:180px;line-height:1.6">
              </div>
            </div>
            <div class="card" style="padding:1.25rem 1.5rem">
              <h3
                style="font-family:var(--mono);font-size:.68rem;letter-spacing:1.5px;text-transform:uppercase;color:var(--muted2);margin-bottom:.85rem">
                Sent Reports Log</h3>
              <div id="em-log">
                <p style="color:var(--muted2);font-size:.84rem">No reports sent yet.</p>
              </div>
            </div>
          </div>
        </div>
