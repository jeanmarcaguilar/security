...
<title>Email Report — CyberShield</title>
    ...
    <div class="topbar">
      <div>
        <div class="tb-bc">
          ...
          <span class="tb-title">Email Report</span>
        </div>
        <p class="tb-sub">Send assessment emails</p>
      </div>
      <div class="tb-right">
...
<div class="sec-hdr"><h2>Send Email Report</h2><p>Compose and send a simulated risk assessment report to a vendor.</p></div>
<div style="display:grid;grid-template-columns:1fr 1fr;gap:1.25rem">
  <div class="card" style="padding:1.5rem">
    <h3 style="font-family:var(--mono);font-size:.68rem;letter-spacing:1.5px;text-transform:uppercase;color:var(--muted2);margin-bottom:1rem">Compose Report Email</h3>
    <div class="fg"><label class="fl">Vendor</label><select class="fi" id="em-vendor" onchange="updatePreview()"></select></div>
    <div class="fg"><label class="fl">Recipient Email</label><input class="fi" type="email" id="em-to" placeholder="vendor@company.com" oninput="updatePreview()"/></div>
    <div class="fg"><label class="fl">Subject</label><input class="fi" type="text" id="em-sub" value="CyberShield Risk Assessment Report" oninput="updatePreview()"/></div>
    <div class="fg"><label class="fl">Additional Note (optional)</label><textarea class="fi" id="em-note" rows="3" placeholder="Add a personal message…" oninput="updatePreview()"></textarea></div>
    <button class="btn btn-p" style="width:100%;justify-content:center" onclick="sendEmail()">
  ...
  <div>
    <div class="card" style="padding:1.5rem;margin-bottom:1.25rem">
      <h3 style="font-family:var(--mono);font-size:.68rem;letter-spacing:1.5px;text-transform:uppercase;color:var(--muted2);margin-bottom:1rem">Email Preview</h3>
      <div id="em-preview" style="background:rgba(255,255,255,.03);border:1px solid var(--border);border-radius:8px;padding:1rem;font-size:.8rem;color:var(--muted2);min-height:180px;line-height:1.6"></div>
    </div>
    <div class="card" style="padding:1.25rem 1.5rem">
      <h3 style="font-family:var(--mono);font-size:.68rem;letter-spacing:1.5px;text-transform:uppercase;color:var(--muted2);margin-bottom:.85rem">Sent Reports Log</h3>
      <div id="em-log"><p style="color:var(--muted2);font-size:.84rem">No reports sent yet.</p></div>
    </div>
  </div>
</div>
