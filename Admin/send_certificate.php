  ...
  <style>
    ...
    *::after {
    ...
    .status-sent {
      ...
      color: var(--green);
      border: 1px solid rgba(16, 217, 130, .25)
    }
    ...
    .cert-type-tag {
      ...
      color: var(--purple);
      border: 1px solid rgba(123, 114, 240, .2)
    }
  </style>
</head>
  ...
  <div id="app">
    ...
    <aside id="sidebar">
      ...
      <div class="sb-section">
        ...
        <a class="sb-item active" href="send_certificate.php"><span class="sb-icon"><svg width="15" height="15"
        ...
        <a class="sb-item" href="email.php"><span class="sb-icon"><svg width="15" height="15" viewBox="0 0 24 24"
              fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round">
              <path d="M4 4h16c1.1 0 2 .9 2 2v16a2 2 0 0 0 2 2H4c-1.1 0-2-.9-2-2V8z" />
              <polyline points="22,6 12,13 2,6" />
            </svg></span><span class="sb-text">Email Report</span></a>
        <div class="sb-divider"></div>
        <div class="sb-label">Quick Actions</div>
        <a class="sb-item" onclick="exportCSV()"><span class="sb-icon"><svg width="15" height="15" viewBox="0 0 24 24"
              fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round">
              <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" />
              <polyline points="7 10 12 15 17 10" />
              <line x1="12" y1="15" x2="12" y2="3" />
            </svg></span><span class="sb-text">Export CSV</span></a>
        <a class="sb-item" onclick="refreshData()"><span class="sb-icon"><svg width="15" height="15" viewBox="0 0 24 24"
              fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round">
    ...
    <div id="main">
      ...
      <div class="content">
        ...
        <div class="tab-panel active" id="tab-send">
          ...
          <!-- Stats row -->
          <div
            style="display:grid;grid-template-columns:repeat(auto-fit,minmax(140px,1fr));gap:.9rem;margin-bottom:1.25rem">
            <div class="card" style="padding:1.1rem 1.2rem;--accent:var(--purple);position:relative;overflow:hidden">
              ...
              <div
                style="font-family:var(--mono);font-size:.58rem;letter-spacing:1.5px;text-transform:uppercase;color:var(--muted2);margin-bottom:.3rem">
                Eligible Users</div>
              <div style="font-family:var(--display);font-size:1.9rem;font-weight:700;color:var(--purple)"
                id="stat-eligible"><?php echo $stats['eligible']; ?></div>
            ...
            <div class="card" style="padding:1.1rem 1.2rem;--accent:var(--teal);position:relative;overflow:hidden">
              ...
              <div style="font-family:var(--display);font-size:1.9rem;font-weight:700;color:var(--teal)"
                id="stat-total"><?php echo $stats['total_assessments']; ?></div>
            ...
            <div class="card" style="padding:1.1rem 1.2rem;--accent:var(--green);position:relative;overflow:hidden">
              ...
              <div
                style="font-family:var(--mono);font-size:.58rem;letter-spacing:1.5px;text-transform:uppercase;color:var(--muted2);margin-bottom:.3rem">
                Certificates Sent</div>
              <div style="font-family:var(--display);font-size:1.9rem;font-weight:700;color:var(--green)"
                id="stat-sent"><?php echo $stats['sent_count']; ?></div>
            ...
            <div class="tbl-bar">
              ...
              <div class="frow">
                ...
                <button class="btn btn-s btn-sm"
                  onclick="document.getElementById('cert-rank-filter').value='';renderCertTbl()">Clear</button>
        ...
        <div class="tab-panel" id="tab-log">
          <div class="card tbl-card">
            ...
            <div id="log-empty"
              style="text-align:center;padding:2.5rem;color:var(--muted2);font-size:.85rem;display:none">
              <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.4"
                stroke-linecap="round" stroke-linejoin="round"
                style="margin:0 auto .75rem;display:block;color:var(--muted)">
                <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
                <polyline points="14 2 14 8 20 8" />
                <path d="M9 15l2 2 4-4" />
              </svg>
