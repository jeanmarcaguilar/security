...
.tab-btns{display:flex;gap:.4rem;margin-bottom:1.25rem;border-bottom:1px solid var(--border);padding-bottom:.65rem;flex-wrap:wrap}
.tab-btn{padding:.4rem .85rem;background:none;border:1px solid transparent;cursor:pointer;border-radius:7px;transition:var(--t);font-family:var(--font);font-size:.8rem;color:var(--muted2)}
.tab-btn.active{background:rgba(59,139,255,.1);color:var(--blue);border-color:rgba(59,139,255,.2)}
...
.danger-zone{border:1px solid rgba(255,59,92,.3);border-radius:12px;padding:1.5rem}
.danger-zone h3{color:var(--red);margin-bottom:1rem;font-family:var(--display);font-size:1.1rem;letter-spacing:1px}
.notif-item{display:flex;justify-content:space-between;align-items:center;padding:.55rem 0;border-bottom:1px solid var(--border)}
.notif-item:last-child{border-bottom:none}
.api-key{font-family:var(--mono);background:rgba(255,255,255,.04);padding:.5rem .85rem;border-radius:8px;word-break:break-all;font-size:.8rem;border:1px solid var(--border2);margin-bottom:.5rem}
</style>
</head>
<body>
...
<a class="sb-item active" href="settings.php"><span class="sb-icon"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="4"/><path d="M6 20v-2a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v2"/></svg></span><span class="sb-text">Settings</span></a>
...
<div class="sec-hdr"><h2>Admin Settings</h2><p>Configure your account, security, notifications, and API access.</p></div>
<div class="tab-btns">
...
<div id="tab-profile" class="tab-c active">
  <div class="settings-grid">
    <div class="card" style="padding:1.5rem">
      <h3 style="font-family:var(--display);font-size:1rem;font-weight:700;margin-bottom:1.15rem">Profile Information</h3>
      <div style="display:flex;align-items:center;gap:1rem;margin-bottom:1.25rem">
        <div style="width:52px;height:52px;border-radius:12px;background:linear-gradient(135deg,var(--red),var(--orange));color:#fff;display:grid;place-items:center;font-size:1.3rem;font-weight:700;font-family:var(--display);flex-shrink:0">A</div>
        <div><div style="font-weight:700;font-size:1rem">Admin User</div><div style="font-size:.8rem;color:var(--muted2)">admin@cybershield.io</div></div>
      </div>
      <div class="fg"><label class="fl">Display Name</label><input class="fi" type="text" value="Admin User"/></div>
      <div class="fg"><label class="fl">Email</label><input class="fi" type="email" value="admin@cybershield.io" readonly/></div>
      <div class="fg"><label class="fl">Organization</label><input class="fi" type="text" value="CyberShield Labs"/></div>
      <div class="fg"><label class="fl">Language</label><select class="fi"><option>English</option><option>Spanish</option><option>French</option></select></div>
      <div class="fg"><label class="fl">Timezone</label><select class="fi"><option>UTC</option><option>Eastern Time</option><option>Pacific Time</option></select></div>
      <button class="btn btn-p" style="width:100%;justify-content:center" onclick="showToast('Profile saved','green')">Save Changes</button>
    </div>
    <div class="card" style="padding:1.5rem">
      <h3 style="font-family:var(--display);font-size:1rem;font-weight:700;margin-bottom:1.15rem">Dashboard Preferences</h3>
      <div class="pref-r"><div><div style="font-size:.88rem;font-weight:600">Dark Mode</div><div style="font-size:.76rem;color:var(--muted2)">Toggle light/dark theme</div></div><label class="ts"><input type="checkbox" id="pref-dark" checked onchange="toggleTheme()"><span class="tsl"></span></label></div>
      <div class="pref-r"><div><div style="font-size:.88rem;font-weight:600">High-Risk Alerts</div><div style="font-size:.76rem;color:var(--muted2)">Notify on critical vendor scores</div></div><label class="ts"><input type="checkbox" checked><span class="tsl"></span></label></div>
      <div class="pref-r"><div><div style="font-size:.88rem;font-weight:600">Auto-Refresh</div><div style="font-size:.76rem;color:var(--muted2)">Refresh data on dashboard load</div></div><label class="ts"><input type="checkbox"><span class="tsl"></span></label></div>
      <div class="pref-r" style="margin-top:.4rem"><div><div style="font-size:.88rem;font-weight:600">Compact View</div><div style="font-size:.76rem;color:var(--muted2)">Reduce padding and spacing</div></div><label class="ts"><input type="checkbox"><span class="tsl"></span></label></div>
    </div>
  </div>
</div>
<!-- SECURITY -->
<div id="tab-security" class="tab-c">
  <div class="settings-grid">
    <div class="card" style="padding:1.5rem">
      <h3 style="font-family:var(--display);font-size:1rem;font-weight:700;margin-bottom:1.15rem">Change Password</h3>
      <div class="fg"><label class="fl">Current Password</label><input class="fi" type="password" placeholder="••••••••"/></div>
      <div class="fg"><label class="fl">New Password</label><input class="fi" type="password" placeholder="••••••••"/><div style="font-size:.72rem;color:var(--muted2);margin-top:.35rem">Min 8 chars, uppercase, lowercase, numbers.</div></div>
      <div class="fg"><label class="fl">Confirm New Password</label><input class="fi" type="password" placeholder="••••••••"/></div>
      <button class="btn btn-p" onclick="showToast('Password updated','green')">Update Password</button>
    </div>
    <div class="card" style="padding:1.5rem">
      <h3 style="font-family:var(--display);font-size:1rem;font-weight:700;margin-bottom:1.15rem">Two-Factor Authentication</h3>
      <div class="notif-item"><div><div style="font-size:.88rem;font-weight:600">Enable 2FA</div><div style="font-size:.76rem;color:var(--muted2)">Secure your account with a second factor</div></div><label class="ts"><input type="checkbox"><span class="tsl"></span></label></div>
      <div class="notif-item"><div><div style="font-size:.88rem;font-weight:600">Active Sessions</div><div style="font-size:.76rem;color:var(--muted2)">2 active sessions</div></div><button class="btn btn-s btn-sm" onclick="showToast('Sessions viewed','blue')">View</button></div>
    </div>
  </div>
</div>
<!-- NOTIFICATIONS -->
<div id="tab-notifications" class="tab-c">
  <div class="card" style="padding:1.5rem;max-width:600px">
    <h3 style="font-family:var(--display);font-size:1rem;font-weight:700;margin-bottom:1.15rem">Notification Preferences</h3>
    <div class="notif-item"><div><div style="font-size:.88rem;font-weight:600">Email Alerts</div><div style="font-size:.76rem;color:var(--muted2)">Receive important security alerts via email</div></div><label class="ts"><input type="checkbox" checked><span class="tsl"></span></label></div>
    <div class="notif-item"><div><div style="font-size:.88rem;font-weight:600">High Risk Vendor Alerts</div><div style="font-size:.76rem;color:var(--muted2)">Get notified when vendors are flagged as high risk</div></div><label class="ts"><input type="checkbox" checked><span class="tsl"></span></label></div>
    <div class="notif-item"><div><div style="font-size:.88rem;font-weight:600">Daily Summary</div><div style="font-size:.76rem;color:var(--muted2)">Receive a daily summary of activities</div></div><label class="ts"><input type="checkbox"><span class="tsl"></span></label></div>
    <div class="notif-item"><div><div style="font-size:.88rem;font-weight:600">Weekly Report</div><div style="font-size:.76rem;color:var(--muted2)">Get weekly comprehensive risk reports</div></div><label class="ts"><input type="checkbox" checked><span class="tsl"></span></label></div>
    <div class="notif-item"><div><div style="font-size:.88rem;font-weight:600">Browser Notifications</div><div style="font-size:.76rem;color:var(--muted2)">Show desktop notifications for important events</div></div><label class="ts"><input type="checkbox"><span class="tsl"></span></label></div>
    <button class="btn btn-p" style="margin-top:1rem" onclick="showToast('Preferences saved','green')">Save Preferences</button>
  </div>
</div>
<!-- API KEYS -->
<div id="tab-api" class="tab-c">
  <div class="card" style="padding:1.5rem;max-width:600px">
    ...
    <div id="api-keys-list"><div class="api-key"><div style="display:flex;justify-content:space-between;align-items:center"><code style="font-family:var(--mono);font-size:.78rem">cybershield_xk9m2p3r7q...••••••••</code><button class="btn btn-s btn-sm" onclick="showToast('Copied','blue')">Copy</button></div><div style="font-size:.7rem;color:var(--muted2);margin-top:.3rem">Created: Jan 15, 2025</div></div></div>
...
<div id="tab-danger" class="tab-c">
  <div class="danger-zone" style="max-width:600px">
    <h3>⚠ Danger Zone</h3>
    <div class="notif-item"><div><div style="font-size:.88rem;font-weight:600">Delete Account</div><div style="font-size:.76rem;color:var(--muted2)">Permanently delete your account and all data</div></div><button class="btn btn-d" onclick="showToast('Confirm in dialog','red')">Delete Account</button></div>
    <div class="notif-item" style="margin-top:.5rem"><div><div style="font-size:.88rem;font-weight:600">Export All Data</div><div style="font-size:.76rem;color:var(--muted2)">Download all your data as JSON</div></div><button class="btn btn-s" onclick="showToast('Data exported','green')">Export Data</button></div>
  </div>
</div>
