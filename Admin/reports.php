    ...
    <div class="topbar">
      <div>
        <div class="tb-bc">
          ...
          <span class="tb-title">Reports</span>
        </div>
        <p class="tb-sub">Detailed assessment analytics</p>
      </div>
      <div class="tb-right">
...
<div class="sec-hdr"><h2>Reports</h2><p>Detailed assessment analytics and downloadable reports.</p></div>
<div class="charts-grid" style="grid-template-columns:1fr 1fr 1fr">
  <div class="card chart-card"><h3>Score Distribution</h3><div class="cw sm"><canvas id="r-bar"></canvas></div></div>
  <div class="card chart-card"><h3>Risk Breakdown</h3><div class="cw sm"><canvas id="r-pie"></canvas></div></div>
  <div class="card chart-card"><h3>Monthly Trend</h3><div class="cw sm"><canvas id="r-line"></canvas></div></div>
</div>
<div class="card tbl-card">
  <div class="tbl-bar">
    <h3>All Assessments</h3>
    <div class="frow">
      <select class="fsel" id="r-rank" onchange="renderRTbl()"><option value="">All Ranks</option><option value="A">A</option><option value="B">B</option><option value="C">C</option><option value="D">D</option></select>
      <button class="btn btn-p btn-sm" onclick="showToast('Report downloaded','green')">⬇ Download</button>
    </div>
  </div>
  <div class="tw"><table><thead><tr><th>Vendor</th><th>Score</th><th>Rank</th><th>Category</th><th>Date</th></tr></thead><tbody id="r-tbl"></tbody></table></div>
