...
<div class="sec-hdr"><h2>Users</h2><p>Manage vendor accounts, roles, and permissions.</p></div>
<div class="stats-row">
  <div class="card stat-card" style="--accent:var(--blue)"><div class="si" style="background:rgba(59,139,255,.12);color:var(--blue)"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75"/></svg></div><div class="slabel">Total Vendors</div><div class="sval">12</div><div class="ssub">Registered</div></div>
  <div class="card stat-card" style="--accent:var(--green)"><div class="si" style="background:rgba(16,217,130,.12);color:var(--green)"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg></div><div class="slabel">Active</div><div class="sval" style="color:var(--green)">10</div><div class="ssub">Currently active</div></div>
  <div class="card stat-card" style="--accent:var(--red)"><div class="si" style="background:rgba(255,59,92,.12);color:var(--red)"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="15" y1="9" x2="9" y2="15"/><line x1="9" y1="9" x2="15" y2="15"/></svg></div><div class="slabel">Inactive</div><div class="sval" style="color:var(--red)">2</div><div class="ssub">Not active</div></div>
  <div class="card stat-card" style="--accent:var(--yellow)"><div class="si" style="background:rgba(245,183,49,.12);color:var(--yellow)"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/></svg></div><div class="slabel">High Risk</div><div class="sval" style="color:var(--yellow)" id="u-hr">—</div><div class="ssub">Rank C or D</div></div>
</div>
<div class="card tbl-card">
  <div class="tbl-bar">
    <h3>All Vendors</h3>
    <div class="frow">
      <input type="text" class="fsel" id="u-search" placeholder="Search vendors…" oninput="renderUTbl()" style="min-width:180px"/>
      <select class="fsel" id="u-rank" onchange="renderUTbl()"><option value="">All Ranks</option><option value="A">A</option><option value="B">B</option><option value="C">C</option><option value="D">D</option></select>
      <button class="btn btn-p btn-sm" onclick="showAddVendorModal()">+ Add Vendor</button>
    </div>
  </div>
  <div class="tw"><table><thead><tr><th>Vendor Name</th><th>Email</th><th>Latest Score</th><th>Rank</th><th>Assessments</th><th>Status</th><th>Actions</th></tr></thead><tbody id="u-tbl"></tbody></table></div>
