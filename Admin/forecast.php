  ...
  <style>
    ...
    *::after {
    ...
    .fc-f.active {
      ...
      border-color: rgba(59, 139, 255, .25) !important
    }
  </style>
</head>
  ...
  <div id="app">
    ...
    <aside id="sidebar">
      ...
      <div class="sb-section">
        ...
        <a class="sb-item active" href="forecast.php"><span class="sb-icon"><svg width="15" height="15"
    ...
    <div id="main">
      ...
      <div class="content">
        ...
        <div class="card" style="padding:1.5rem;margin-bottom:1.25rem">
          <div
            style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:1rem;margin-bottom:1.25rem">
            <h3
              style="font-family:var(--mono);font-size:.68rem;letter-spacing:1.5px;text-transform:uppercase;color:var(--muted2)">
              Trend-Based Forecast</h3>
          ...
          <div id="fc-grid" style="display:grid;grid-template-columns:repeat(auto-fill,minmax(220px,1fr));gap:.9rem">
          </div>
        </div>
