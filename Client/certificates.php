  ...
  <style>
    ...
    *::after {
    ...
    .cert-card:hover {
      ...
      box-shadow: 0 8px 30px rgba(245, 183, 49, .1)
    }
    ...
    .cert-medal {
      ...
      place-items: center;
      flex-shrink: 0;
      box-shadow: 0 0 14px rgba(245, 183, 49, .4)
    }
    ...
    .cert-rank-A {
      ...
      color: var(--green);
      border: 1px solid rgba(16, 217, 130, .3)
    }

    .cert-rank-B {
      background: rgba(59, 139, 255, .15);
      color: var(--blue);
    ...
    #cert-print-template .cert-logo-area {
      display: flex;
      align-items: center;
      gap: 10px;
      margin-bottom: 28px
    ...
    #cert-print-template .cert-shield {
      width: 42px;
      height: 42px;
      background: linear-gradient(135deg, #3B8BFF, #7B72F0);
      border-radius: 11px;
      display: grid;
      place-items: center
    }

    #cert-print-template .cert-brand {
    ...
    #cert-print-template .cert-headline {
      font-family: 'Syne', sans-serif;
      font-size: 2rem;
      font-weight: 800;
      color: #0a0a0a;
    ...
    #cert-print-template .cert-subline {
      font-size: .85rem;
      color: #475569;
      margin-bottom: 28px
    }

    #cert-print-template .cert-awardee {
      font-family: 'Syne', sans-serif;
      font-size: 1.55rem;
      font-weight: 700;
      color: #1a1a2e;
    ...
    #cert-print-template .cert-for {
      font-size: .82rem;
      color: #64748b;
      margin-bottom: 24px
    }

    #cert-print-template .cert-details-grid {
      display: grid;
    ...
    #cert-print-template .cert-detail-box {
      background: #f8fafc;
    ...
    #cert-print-template .cert-detail-label {
      font-size: .6rem;
      text-transform: uppercase;
      letter-spacing: 1px;
      color: #94a3b8;
    ...
    #cert-print-template .cert-detail-val {
      font-size: .95rem;
      font-weight: 700;
      color: #0a0a0a
    }

    #cert-print-template .cert-seal {
      display: flex;
      align-items: center;
      gap: 12px;
      padding-top: 20px;
    ...
    #cert-print-template .cert-seal-circle {
      width: 56px;
      height: 56px;
      border-radius: 50%;
      background: linear-gradient(135deg, #F5B731, #FF8C42);
      display: grid;
      place-items: center;
      flex-shrink: 0;
    ...
    #cert-print-template .cert-seal-text {
      font-size: .75rem;
      color: #64748b
    }

    #cert-print-template .cert-seal-text strong {
      display: block;
      font-size: .85rem;
      color: #0a0a0a
    }

    #cert-print-template .cert-id {
      font-family: 'JetBrains Mono', monospace;
      font-size: .6rem;
      color: #94a3b8;
      margin-top: 4px
  ...
  <div id="app">
    ...
    <aside id="sidebar">
      ...
      <div class="sb-section">
        ...
        <a class="sb-item active" href="certificates.php"><span class="sb-icon"><svg width="15" height="15"
              ...
              <div class="cert-card">
                ...
                <div class="cert-body">
                  ...
                  <div class="cert-row">
                    ...
                    <span
                      class="cert-row-val"><?php echo htmlspecialchars($a['vendor_name'] ?? $user['store_name'] ?? '--'); ?></span>
                  </div>
                  <div class="cert-row">
                  ...
                  <div class="cert-row">
                    ...
                    <span class="cert-row-val"
                      style="font-family:var(--mono);font-size:.7rem;color:var(--muted2)"><?php echo $certId; ?></span>
                  </div>
                </div>
              ...
              <div class="cert-card">
                ...
                <div class="cert-body">
                  <div class="cert-row">
                    <span class="cert-row-label">Recipient</span>
                    <span
                      class="cert-row-val"><?php echo htmlspecialchars($cert['recipient_name'] ?? $user['full_name']); ?></span>
                  </div>
                  <div class="cert-row">
                  ...
                  <div class="cert-row">
                    <span class="cert-row-label">Store / Vendor</span>
                    <span
                      class="cert-row-val"><?php echo htmlspecialchars($cert['store_name'] ?? $user['store_name'] ?? '--'); ?></span>
                  </div>
                  <div class="cert-row">
                    <span class="cert-row-label">Overall Score</span>
                    <span class="score-pill score-<?php echo $rank; ?>"><?php echo $score; ?>%</span>
                  ...
                  <div class="cert-row">
                    <span class="cert-row-label">Certificate ID</span>
                    <span class="cert-row-val"
                      style="font-family:var(--mono);font-size:.7rem;color:var(--muted2)"><?php echo htmlspecialchars($cert['cert_id']); ?></span>
                  </div>
                  <div class="cert-row">
