...
const ALL_QUESTIONS = [
  {
    ...
    catKey: "password",
    icon: "🔑",
    q: "How do you typically manage your passwords for work accounts?",
    opts: [
      { text: "Use a password manager with unique passwords", score: 3 },
      { text: "Write them down in a secure notebook", score: 1 },
      { text: "Reuse the same strong password across sites", score: 1 },
      { text: "Use simple, memorable passwords", score: 0 },
    ],
  },
  {
    id: "p2",
    ...
    catKey: "password",
    icon: "🔑",
    q: "How often do you update your work account passwords?",
    opts: [
      { text: "Every 90 days or when prompted by policy", score: 3 },
      { text: "Once a year", score: 1 },
      { text: "Only when forced or after a breach", score: 1 },
      { text: "Never — I keep the same password", score: 0 },
    ],
  },
  {
    id: "p3",
    ...
    catKey: "password",
    icon: "🔑",
    q: "Which of the following qualifies as a strong password?",
    opts: [
      { text: "T#9mK@2vL!qR (random mixed characters)", score: 3 },
      { text: "Company2024! (company + year)", score: 1 },
      { text: "P@ssword1 (common substitution)", score: 0 },
      { text: "12345678 (sequential digits)", score: 0 },
    ],
  },
  {
    id: "ph1",
    cat: "Phishing Awareness",
    catKey: "phishing",
    icon: "🎣",
    q: 'You receive an urgent email from "IT Support" asking you to click a link and reset your credentials immediately. What do you do?',
    opts: [
      {
        text: "Do not click; verify via official channel or call IT directly",
        score: 3,
      },
      { text: "Click but only enter a fake password first", score: 1 },
      { text: "Forward to colleagues to warn them", score: 1 },
      { text: "Click the link and follow instructions", score: 0 },
    ],
  },
  {
    id: "ph2",
    ...
    catKey: "phishing",
    icon: "🎣",
    q: "Which is a reliable indicator that an email may be a phishing attempt?",
    opts: [
      { text: "Mismatched sender domain (e.g. support@paypa1.com)", score: 3 },
      { text: "The email arrived on a Monday", score: 0 },
      { text: "It is written in formal English", score: 0 },
      { text: "It has a company logo attached", score: 0 },
    ],
  },
  {
    id: "ph3",
    ...
    catKey: "phishing",
    icon: "🎣",
    q: "Multi-Factor Authentication (MFA) primarily helps by:",
    opts: [
      {
        text: "Requiring a second verification even if a password is stolen",
        score: 3,
      },
      { text: "Making your password longer automatically", score: 0 },
      { text: "Blocking all phishing emails before they arrive", score: 0 },
      { text: "Encrypting your email attachments", score: 0 },
    ],
  },
  {
    id: "d1",
    ...
    catKey: "device",
    icon: "💻",
    q: "Your laptop will be left unattended in a coffee shop for 10 minutes. What should you do?",
    opts: [
      {
        text: "Lock the screen (Win+L / Cmd+Ctrl+Q) and take it with you",
        score: 3,
      },
      { text: "Lock the screen and leave it at the table", score: 2 },
      { text: "Put the lid down and leave it", score: 1 },
      { text: "Leave it open — it's only 10 minutes", score: 0 },
    ],
  },
  {
    id: "d2",
    ...
    catKey: "device",
    icon: "💻",
    q: "How frequently should operating system security patches be applied to work devices?",
    opts: [
      {
        text: "As soon as possible after release, within policy window",
        score: 3,
      },
      { text: "Once a quarter during scheduled downtime", score: 1 },
      { text: "Only when performance issues occur", score: 0 },
      { text: "Never — patches can break software", score: 0 },
    ],
  },
  {
    id: "d3",
    ...
    catKey: "device",
    icon: "💻",
    q: "Which storage practice is safest for sensitive work files?",
    opts: [
      {
        text: "Company-approved encrypted cloud storage with access control",
        score: 3,
      },
      { text: "Personal USB drive kept in your desk drawer", score: 1 },
      { text: "Personal Google Drive or Dropbox (free tier)", score: 1 },
      { text: "Email attachments to yourself for easy access", score: 0 },
    ],
  },
  {
    id: "n1",
    ...
    catKey: "network",
    icon: "📡",
    q: "You need to access your company's internal system while working at a café. What should you do?",
    opts: [
      {
        text: "Use the company-issued VPN before connecting to any work resources",
        score: 3,
      },
      { text: "Use the café Wi-Fi only for non-sensitive browsing", score: 1 },
      { text: "Use your phone hotspot for all work tasks", score: 2 },
      { text: "Connect directly — café Wi-Fi is usually fine", score: 0 },
    ],
  },
  {
    id: "n2",
    ...
    catKey: "network",
    icon: "📡",
    q: "What does HTTPS in a browser URL primarily guarantee?",
    opts: [
      {
        text: "The connection between your browser and the server is encrypted",
        score: 3,
      },
      { text: "The website is 100% safe and verified legitimate", score: 0 },
      { text: "Your IP address is hidden from the server", score: 0 },
      { text: "No data is stored by the website", score: 0 },
    ],
  },
  {
    id: "n3",
    ...
    catKey: "network",
    icon: "📡",
    q: 'Someone connects an unknown USB drive found in the parking lot to their work laptop to "see whose it is." This action is:',
    opts: [
      { text: "Dangerous — USB drives can auto-execute malware", score: 3 },
      { text: "Fine if antivirus is active", score: 1 },
      { text: "Acceptable if you only view files, not run them", score: 0 },
      { text: "Helpful — you can return it to the owner", score: 0 },
    ],
  },
];
...
const VIDEOS = {
  phishing: [
    {
      id: "XBkzBrXlle0",
      label: "Phishing Attacks Explained",
      sub: "How attackers craft convincing emails",
    },
    {
      id: "aO858HyFbKI",
      label: "Recognizing Phishing",
      sub: "Red flags to watch for",
    },
  ],
  password: [
    {
      id: "aEmXfkwJ3pk",
      label: "Password Security Best Practices",
      sub: "Creating and managing strong passwords",
    },
  ],
  device: [
    {
      id: "Dk-ZqQ-bfy4",
      label: "Endpoint Security Fundamentals",
      sub: "Protecting your devices from threats",
    },
  ],
  network: [
    {
      id: "_GzE99AmAQU",
      label: "Public Wi-Fi Dangers",
      sub: "Risks of unprotected networks",
    },
    {
      id: "iYWT5oE8pAw",
      label: "VPN Explained",
      sub: "Why and how to use a VPN",
    },
  ],
};
  ...
  password: [
    {
      ...
      body: "Tools like Bitwarden or 1Password generate and store unique credentials for every account.",
    },
    {
      icon: "🔢",
      title: "Enable Two-Factor Authentication",
      body: "Add a second layer via authenticator app (TOTP) — not just SMS.",
    },
    {
      icon: "📏",
      title: "Minimum 16-Character Passphrases",
      body: "Combine 4+ random words for strong yet memorable passwords.",
    },
  ],
  phishing: [
    {
      ...
      body: "Always hover over links to inspect the destination URL and confirm sender email domains.",
    },
    {
      icon: "📞",
      title: "Call to Confirm",
      body: "If an urgent request arrives by email, call the sender directly using a known official number.",
    },
    {
      icon: "🛡️",
      title: "Report Suspicious Emails",
      body: "Use your company's phishing report button or forward to your security team immediately.",
    },
  ],
  device: [
    {
      icon: "🔒",
      title: "Auto-Lock Your Screen",
      body: "Set your device to lock automatically after 2–5 minutes of inactivity.",
    },
    {
      icon: "💾",
      title: "Enable Full-Disk Encryption",
      body: "Use BitLocker (Windows) or FileVault (Mac) to protect data if your device is lost or stolen.",
    },
    {
      icon: "🔄",
      title: "Keep Software Updated",
      body: "Apply OS and application patches promptly — most exploits target known, unpatched vulnerabilities.",
    },
  ],
  network: [
    {
      icon: "🌐",
      title: "Always Use VPN on Public Wi-Fi",
      body: "A VPN encrypts your traffic, preventing eavesdropping on coffee shop or hotel networks.",
    },
    {
      icon: "📵",
      title: "Disable Auto-Connect to Wi-Fi",
      body: "Prevent your device from joining rogue hotspots that mimic trusted networks.",
    },
    {
      icon: "🔌",
      title: "Never Use Unknown USB Devices",
      body: "Malicious USBs can silently install malware the moment they're plugged in.",
    },
  ],
};
...
const RANK_CONFIG = {
  A: {
    ...
    label: "Low Risk",
    desc: "Excellent security posture! Keep up the good practices.",
  },
  B: {
    color: "var(--yellow)",
    faint: "var(--yellow-faint)",
    label: "Moderate Risk",
    desc: "Good foundation — a few areas need attention.",
  },
  C: {
    color: "var(--orange)",
    faint: "var(--orange-faint)",
    label: "High Risk",
    desc: "Several vulnerabilities identified. Action recommended.",
  },
  D: {
    color: "var(--red)",
    faint: "var(--red-faint)",
    label: "Critical Risk",
    desc: "Significant security gaps. Immediate training required.",
  },
};
...
const ALL_BADGES = [
  ...
  },
  {
    ...
    icon: "💎",
    label: "Perfect Score",
    desc: "Score 100% on any assessment",
  },
  { id: "rankA", icon: "🛡️", label: "Low Risk", desc: "Achieve Rank A" },
  {
    ...
    icon: "📈",
    label: "Improving",
    desc: "Score higher than your previous attempt",
  },
  {
    id: "speedster",
    icon: "⏱️",
    label: "Speed Demon",
    desc: "Finish under 3 minutes",
  },
  {
    id: "allcat",
    icon: "🌐",
    label: "All-Rounder",
    desc: "Score ≥70% in all 4 categories",
  },
];

function getEarnedBadges() {
  return JSON.parse(localStorage.getItem("cs_badges") || "[]");
}
function saveEarnedBadges(b) {
  localStorage.setItem("cs_badges", JSON.stringify(b));
}
...
function checkAndAwardBadges(record, elapsed) {
  ...
  if (history.length >= 2 && record.pct > history[history.length - 2].pct)
    award("improved");
...
// ═══════════════════════════════════════════════════════════════
function getNotifs() {
  return JSON.parse(localStorage.getItem("cs_notifs") || "[]");
}
function saveNotifs(n) {
  localStorage.setItem("cs_notifs", JSON.stringify(n));
}
...
function renderNotifList() {
  ...
  if (!el) return;
  if (!notifs.length) {
    el.innerHTML = '<p class="notif-empty">No notifications</p>';
    return;
  }
  el.innerHTML = notifs
    .map(
...
function updateTimerUI() {
  ...
  valEl.className =
    "timer-val" +
    (timerLeft <= 5 ? " urgent" : timerLeft <= 10 ? " warning" : "");
  ...
  if (answers[questions[currentQ].id] === undefined) {
    ...
    document.querySelectorAll(".option-btn").forEach(function (btn, idx) {
      const maxScore = Math.max.apply(
        null,
        questions[currentQ].opts.map(function (o) {
          return o.score;
        }),
      );
      if (
        questions[currentQ].opts[idx] &&
        questions[currentQ].opts[idx].score === maxScore
      )
...
function getHistory() {
  return JSON.parse(localStorage.getItem("cs_history") || "[]");
}
function saveHistory(h) {
  localStorage.setItem("cs_history", JSON.stringify(h));
}
...
function renderDashboard() {
  ...
  if (history.length > 0) {
    ...
    document.getElementById("stat-rank").innerHTML =
    ...
    if (history.length >= 2) {
      ...
      document.getElementById("stat-trend-sub").textContent =
        diff >= 0 ? "Improved from last" : "Declined from last";
    } else {
    ...
    ["stat-score", "stat-rank", "stat-trend"].forEach(function (id) {
      document.getElementById(id).textContent = "—";
    });
    document.getElementById("stat-rank-text").textContent =
      "No assessments yet";
    document.getElementById("stat-rank-sub").textContent = "—";
    document.getElementById("stat-trend-sub").textContent = "—";
  }
  ...
  if (!history.length) {
    container.innerHTML =
      '<p style="color:var(--text-2);font-size:.88rem;padding:.5rem 0;">No assessments taken yet. Start one now!</p>';
  } else {
    const rows = [...history]
      .reverse()
      .slice(0, 8)
      .map(function (h) {
        return (
          ...
          formatDate(h.date) +
          "</td>" +
          '<td class="mono" style="font-size:.88rem;">' +
          h.pct +
          "%</td>" +
      ...
      .join("");
    container.innerHTML =
      '<table class="history-table"><thead><tr><th>Date</th><th>Score</th><th>Rank</th><th>Points</th></tr></thead><tbody>' +
      rows +
      "</tbody></table>";
  }
  renderTrendChart("trend-chart", trendChart, function (c) {
    trendChart = c;
  });
}
...
function renderTrendChart(canvasId, chartRef, setter) {
  ...
  const data = history.map(function (h) {
    return h.pct;
  });
...
function startAssessment() {
  ...
  cats.forEach(function (cat) {
    const pool = ALL_QUESTIONS.filter(function (q) {
      return q.catKey === cat;
    });
    shuffle(pool)
      .slice(0, 3)
      .forEach(function (q) {
        questions.push(Object.assign({}, q, { opts: shuffle(q.opts) }));
      });
  });
...
function renderQuestion() {
  ...
  const optHtml = q.opts
    .map(function (o, i) {
      return (
        '<button class="option-btn" id="opt-' +
        i +
...
function selectOption(i) {
  ...
  document.querySelectorAll(".option-btn").forEach(function (btn, idx) {
    if (idx === i)
      btn.classList.add(selected === maxScore ? "correct" : "wrong");
    else if (
      questions[currentQ].opts[idx] &&
      questions[currentQ].opts[idx].score === maxScore &&
      selected < maxScore
...
function finishAssessment() {
  ...
  const totalScore = Object.values(catScores).reduce(function (a, b) {
    return a + b;
  }, 0);
  const totalMax = Object.values(catMax).reduce(function (a, b) {
    return a + b;
  }, 0);
  ...
  Object.keys(catScores).forEach(function (k) {
    catPct[k] =
      catMax[k] > 0 ? Math.round((catScores[k] / catMax[k]) * 100) : 0;
  });
  ...
  if (newBadges.length) {
    const names = newBadges
      .map(function (id) {
        return ALL_BADGES.find(function (b) {
          return b.id === id;
        }).label;
      })
      .join(", ");
...
function renderResults() {
  ...
  if (!history.length) {
    document.getElementById("result-hero").innerHTML =
      '<p style="padding:2rem;color:var(--text-2);">No assessments yet. Start one from the dashboard.</p>';
    return;
  }
  const latest = history[history.length - 1],
    rank = latest.rank,
  ...
  document.getElementById("result-hero").innerHTML =
    '<div class="rank-big" style="background:' +
    cfg.faint +
    ";color:" +
    cfg.color +
    ';">' +
    ...
    cfg.label +
    "</h2>" +
    '<p class="score-text">Score: <span class="score-num">' +
    latest.pct +
    "%</span> &nbsp;·&nbsp; " +
    latest.score +
    "/" +
    latest.max +
    " points</p>" +
    '<p style="color:var(--text-2);font-size:.88rem;margin-top:.6rem;max-width:460px;margin-left:auto;margin-right:auto;line-height:1.6;">' +
    cfg.desc +
    "</p>" +
    '<p style="color:var(--text-3);font-size:.76rem;margin-top:1rem;letter-spacing:.04em;">ASSESSED ON ' +
    formatDate(latest.date).toUpperCase() +
    "</p>";
  ...
  radarChart = new Chart(document.getElementById("radar-chart"), {
    ...
    data: {
      ...
      datasets: [
        {
          label: "Score (%)",
          data: catKeys.map(function (k) {
            return latest.catPct[k] || 0;
          }),
          backgroundColor: "rgba(91,79,232,.15)",
          borderColor: "#7B72F0",
          pointBackgroundColor: "#7B72F0",
    ...
    options: {
      ...
      scales: {
        r: {
          min: 0,
          max: 100,
          backgroundColor: "rgba(10,15,30,.5)",
          ticks: {
            stepSize: 25,
            color: "#4d5d7a",
            font: { size: 10 },
          ...
          grid: { color: "rgba(59,139,255,.05)" },
          angleLines: { color: "rgba(59,139,255,.04)" },
        },
      },
    },
  });
  ...
  // Recs
  const sorted = catKeys
    .map(function (k) {
      return { k, pct: latest.catPct[k] || 0 };
    })
    .sort(function (a, b) {
      return a.pct - b.pct;
    });
  ...
  sorted.slice(0, 2).forEach(function (s) {
    RECOMMENDATIONS[s.k].forEach(function (r) {
      recoHtml.push(
        '<li class="reco-item"><span class="reco-icon">' +
          r.icon +
          "</span><div><strong>" +
          r.title +
          "</strong><p>" +
  ...
  document.getElementById("reco-list").innerHTML = recoHtml
    .slice(0, 5)
    .join("");

  // Trend
  renderTrendChart("trend-chart-2", trendChart2, function (c) {
    trendChart2 = c;
  });

  // Videos
  const weakCats = sorted.slice(0, 2).map(function (s) {
    return s.k;
  });
  document.getElementById("video-grid").innerHTML = weakCats
    .flatMap(function (cat) {
      return (VIDEOS[cat] || []).map(function (v) {
        return (
          '<div class="video-thumb"><iframe src="https://www.youtube.com/embed/' +
          v.id +
          '" allowfullscreen loading="lazy"></iframe>' +
          '<div class="video-thumb-label">' +
          v.label +
          '</div><div class="video-thumb-sub">' +
          v.sub +
          "</div></div>"
        );
      });
...
function buildReviewData(sorted) {
  ...
  const html = questions
    .map(function (q, qi) {
      ...
      if (timedOut) {
        inner +=
          '<div class="review-ans" style="color:var(--orange);">⏱ Timed out — no answer selected</div>';
      } else {
        inner +=
      ...
      if (!isCorrect) {
        const correctIdx = q.opts.findIndex(function (o) {
          return o.score === maxScore;
        });
        inner +=
          '<div class="review-ans show-correct">💡 Best answer: ' +
          letters[correctIdx] +
          ". " +
          q.opts[correctIdx].text +
          "</div>";
      }
      return (
...
function renderLeaderboard(filter) {
  ...
  const myEntry = {
    ...
    pct: myLatest ? myLatest.pct : 0,
    rank: myLatest ? myLatest.rank : "D",
    isMe: true,
  };
  const selfIdx = data.findIndex(function (d) {
    return d.isMe;
  });
  ...
  document.getElementById("leaderboard-list").innerHTML =
    html ||
    '<p style="color:var(--text-2);padding:1rem 0;font-size:.88rem;">No vendors found for this filter.</p>';
}

function filterLeaderboard(filter, btn) {
  document.querySelectorAll(".lb-filter-btn").forEach(function (b) {
...
function renderProfile() {
  ...
  document.getElementById("profile-avatar-big").textContent = name
    .charAt(0)
    .toUpperCase();
  ...
  // Sync toggle changes
  if (prefTimer)
    prefTimer.onchange = function () {
      setPref("timer", this.checked);
    };
  if (prefNotif)
    prefNotif.onchange = function () {
      setPref("notif", this.checked);
    };
  ...
  grid.innerHTML = [
    ...
    {
      label: "Badges",
      val: getEarnedBadges().length + "/" + ALL_BADGES.length,
    },
  ]
    .map(function (s) {
      return (
        '<div class="profile-stat-item"><div class="label">' +
        s.label +
...
function saveProfile() {
  const name =
    document.getElementById("profile-name").value.trim() || session.name;
  ...
  document.getElementById("nav-avatar").textContent = name
    .charAt(0)
    .toUpperCase();
...
function printResult() {
  ...
  const catBars = cats
    .map(function (k) {
      ...
      return (
        '<div class="print-cat-bar">' +
        '<div class="print-cat-label">' +
        catLabels[k] +
        "</div>" +
        '<div class="print-bar-bg"><div class="print-bar-fill" style="width:' +
        pct +
        '%"></div></div>' +
        '<div class="print-pct">' +
        pct +
  ...
  sorted.slice(0, 2).forEach(function (s) {
    RECOMMENDATIONS[s.k].slice(0, 2).forEach(function (r) {
      recoItems.push(r);
    });
  });
  ...
  document.getElementById("print-area").innerHTML =
    ...
    '<div style="margin-left:auto;text-align:right;font-size:.8rem;color:#64748B;"><div>' +
    session.name +
    "</div><div>" +
    formatDate(latest.date) +
    "</div></div></div>" +
    '<div class="print-score-block">' +
    '<div class="print-rank" style="color:' +
    cfg.color +
    '">' +
    rank +
    "</div>" +
    '<div><div style="font-size:1.2rem;font-weight:800;">' +
    cfg.label +
    "</div>" +
    '<div style="font-size:.9rem;color:#475569;margin-top:.25rem;">Score: ' +
    latest.pct +
    "% &nbsp;·&nbsp; " +
    latest.score +
    "/" +
    latest.max +
    " points</div></div></div>" +
    '<h3 style="margin-bottom:.75rem;font-size:1rem;">Category Breakdown</h3>' +
    catBars +
    ...
    recoItems
      ...
      .map(function (r) {
        return (
          '<div class="print-reco"><strong>' +
          r.icon +
          " " +
          r.title +
          '</strong><div style="font-size:.82rem;color:#475569;margin-top:.2rem;">' +
          r.body +
          "</div></div>"
        );
      })
...
function exportCSV() {
  ...
  const rows = history.map(function (h) {
    return [
      ...
      h.max,
      h.rank,
      (h.catPct && h.catPct.password) || 0,
      (h.catPct && h.catPct.phishing) || 0,
      (h.catPct && h.catPct.device) || 0,
      (h.catPct && h.catPct.network) || 0,
    ].join(",");
  });
  ...
  a.href = url;
  a.download = "cybershield_assessment_history.csv";
  a.click();
...
function exportPDF() {
  ...
  doc.roundedRect(14, 78, 182, 42, 5, 5, "F");
  doc.setFillColor(91, 79, 232);
  doc.roundedRect(14, 78, 4, 42, 2, 0, "F");
  doc.setFontSize(32);
  doc.setFont("helvetica", "bold");
  doc.setTextColor(123, 114, 240);
  doc.text(rank, 28, 106);
  doc.setFontSize(15);
  doc.setTextColor(240, 244, 255);
  doc.text(cfg.label, 55, 96);
  doc.setFontSize(11);
  doc.setFont("helvetica", "normal");
  doc.setTextColor(136, 152, 187);
  doc.text(
  ...
  var cats = [
    { label: "Password Security", key: "password" },
    { label: "Phishing Awareness", key: "phishing" },
    { label: "Device Safety", key: "device" },
    { label: "Network Safety", key: "network" },
  ];
  cats.forEach(function (c, i) {
    var y = 148 + i * 16,
      pct = (latest.catPct && latest.catPct[c.key]) || 0;
    doc.setFontSize(9);
    doc.setFont("helvetica", "normal");
    doc.setTextColor(60, 70, 90);
    doc.text(c.label, 14, y);
    doc.setFillColor(20, 31, 56);
    doc.roundedRect(80, y - 5, 92, 7, 2, 2, "F");
    doc.setFillColor(91, 79, 232);
    doc.roundedRect(80, y - 5, Math.max(2, 92 * (pct / 100)), 7, 2, 2, "F");
    doc.setTextColor(50, 60, 80);
    doc.text(pct + "%", 178, y);
  });
  // Badges in PDF
  ...
  if (earned.length) {
    ...
    doc.text(
      earned
        .map(function (id) {
          var b = ALL_BADGES.find(function (x) {
            return x.id === id;
          });
          return b ? b.label : "";
        })
  ...
  var sortedCats = cats.slice().sort(function (a, b) {
    return (
      ((latest.catPct && latest.catPct[a.key]) || 0) -
      ((latest.catPct && latest.catPct[b.key]) || 0)
    );
  });
  var allRecos = [];
  sortedCats.slice(0, 2).forEach(function (c) {
    RECOMMENDATIONS[c.key].slice(0, 2).forEach(function (r) {
      allRecos.push(r);
    });
  });
  ...
  doc.text(
    "Generated by CyberShield Assessment Platform — Confidential",
    14,
    291,
  );
...
window.addEventListener("load", function () {
  ...
  if (!localStorage.getItem("cs_history")) {
    var seed = [],
      now = Date.now(),
      demoScores = [52, 61, 58, 70, 75, 82];
    demoScores.forEach(function (pct, i) {
      seed.push({
        date: new Date(
          now - (demoScores.length - 1 - i) * 7 * 86400000,
        ).toISOString(),
        score: Math.round(pct * 0.36),
        max: 36,
        pct,
        rank: getRank(pct),
        elapsed: 180 + Math.floor(Math.random() * 120),
        catPct: {
          password: Math.max(
            0,
            Math.min(100, pct - 5 + Math.floor(Math.random() * 12)),
          ),
          phishing: Math.max(
            0,
            Math.min(100, pct - 8 + Math.floor(Math.random() * 14)),
          ),
          device: Math.max(
            0,
            Math.min(100, pct + 2 + Math.floor(Math.random() * 10)),
          ),
          network: Math.max(
            0,
            Math.min(100, pct - 3 + Math.floor(Math.random() * 10)),
          ),
        },
      });
    });
...
const TRANSLATIONS = {
  en: {
    ...
    login_sub:
      "Sign in to access your cybersecurity assessment portal and track your risk profile.",
  ...
  fil: {
    ...
    login_sub:
      "Mag-sign in para ma-access ang iyong portal ng pagtatasa sa cybersecurity.",
    email_label: "Email address",
    pass_label: "Password",
    ...
    dash_sub:
      "Narito ang iyong pangkalahatang-ideya ng cybersecurity hygiene ngayon.",
    leaderboard_btn: "🏆 Leaderboard",
    ...
    new_assessment_sub:
      "Kumuha ng sariwang 12-tanong na pagsubok sa cybersecurity",
    ...
    fp_new_pass_sub:
      "Pumili ng matibay na bagong password para sa iyong account.",
...
function doForgotStep2() {
  var code = (document.getElementById("fp-code-input").value || "")
    .trim()
    .toUpperCase();
  ...
  if (np) {
    np.value = "";
    np.addEventListener("input", checkPassStrength);
  }
}
...
function clearAllData() {
  if (
    !confirm(
      "Are you sure you want to delete all your assessment data? This cannot be undone.",
    )
  )
    return;
  var keys = [
...
function saveProducts(p) {
  localStorage.setItem("cs_products", JSON.stringify(p));
}
...
function filterProducts(f, btn) {
  _productFilter = f;
  document
    .querySelectorAll("#page-seller-store .filter-btn")
    .forEach(function (b) {
      b.classList.remove("active");
    });
  if (btn) btn.classList.add("active");
  ...
  grid.innerHTML = filtered
    .map(function (p) {
      ...
      var imgHtml = p.image
        ? '<img src="' +
          p.image +
          '" onerror="this.style.display=\'none\';this.nextElementSibling.style.display=\'flex\'"/><div class="product-img-placeholder" style="display:none">' +
          (ICONS[p.category] || "📦") +
          "</div>"
      ...
      return (
        ...
        escHtml(p.description || "No description provided.") +
        "</div>" +
        '<div class="product-meta">' +
        '<div class="product-price">₱' +
        parseFloat(p.price).toLocaleString("en-PH", {
        ...
        '<button class="product-action-btn edit" onclick="openProductModal(\'' +
        p.id +
        "')\">" +
        ...
        "</button>" +
        '<button class="product-action-btn" onclick="toggleProductStatus(\'' +
        p.id +
        "')\">" +
        '<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><circle cx="12" cy="12" r="10"/>' +
        (p.status === "active"
        ...
        "</button>" +
        '<button class="product-action-btn delete" onclick="deleteProduct(\'' +
        p.id +
        "')\">" +
...
function updateSellerStats(products) {
  ...
  var oos = products.filter(function (p) {
    return p.stock <= 0;
  }).length;
  var value = products.reduce(function (s, p) {
    return s + parseFloat(p.price || 0) * parseInt(p.stock || 0);
  }, 0);
...
function openProductModal(id) {
  ...
  if (id) {
    ...
    ["p-name", "p-desc", "p-price", "p-stock", "p-image"].forEach(
      function (id) {
...
function saveProduct() {
  ...
  if (isNaN(stock) || stock < 0) {
    errEl.textContent = "Enter a valid stock quantity.";
    errEl.style.display = "block";
    return;
  }
...
function setAnalyticsPeriod(days, btn) {
  ...
  document
    .querySelectorAll("#page-seller-analytics .filter-btn")
    .forEach(function (b) {
      b.classList.remove("active");
    });
  if (btn) btn.classList.add("active");
...
function renderAnalyticsDashboard() {
  ...
  var now = Date.now();
  var DAY = 86400000;
  var slice = allData.filter(function (d) {
    return d.ts >= now - _analyticsPeriod * DAY;
  });
  var prev = allData.filter(function (d) {
    return (
      d.ts >= now - _analyticsPeriod * 2 * DAY &&
      d.ts < now - _analyticsPeriod * DAY
    );
  });
  ...
  var pEngage =
    pViews > 0 ? ((sum(prev, "orders") / pViews) * 100).toFixed(1) : 0;
  ...
  setTrend(
    "kpi-revenue-trend",
    trendText(revenue, pRevenue),
    trendClass(revenue, pRevenue),
  );
  setTrend(
    "kpi-orders-trend",
    trendText(orders, pOrders),
    trendClass(orders, pOrders),
  );
  setTrend(
    "kpi-views-trend",
    trendText(views, pViews),
    trendClass(views, pViews),
  );
  setTrend(
    "kpi-engage-trend",
    trendText(parseFloat(engage), parseFloat(pEngage)),
    trendClass(parseFloat(engage), parseFloat(pEngage)),
  );
...
function renderAnalyticsCharts(slice) {
        ...
        datasets: [
          {
            ...
            borderColor: "#3b8bff",
            backgroundColor: "rgba(59,139,255,.08)",
            tension: 0.4,
            fill: true,
            pointRadius: slice.length > 30 ? 0 : 3,
  ...
  var catData = cats.map(function (c, i) {
    return Math.floor(5 + Math.random() * 40);
  });
    ...
    _analyticsCharts["category"] = new Chart(cc, {
      ...
      data: {
        ...
        datasets: [
          {
            data: catData,
            backgroundColor: catColors.map(function (c) {
              return c + "cc";
            }),
        ...
        datasets: [
          {
            ...
            backgroundColor: "rgba(176,97,255,.5)",
            borderColor: "#b061ff",
            borderWidth: 1,
            borderRadius: 3,
          },
          {
            ...
            backgroundColor: "rgba(0,232,130,.5)",
            borderColor: "#00e882",
            borderWidth: 1,
            borderRadius: 3,
          },
...
function renderTopProducts() {
  ...
  if (!products.length) {
    el.innerHTML =
      '<p class="empty-state">No products listed yet. Add products to see performance data.</p>';
    return;
  }
    ...
    enriched
      ...
      .map(function (p, i) {
        ...
        return (
          ...
          escHtml(p.name) +
          "</div>" +
          '<div class="tp-bar-wrap"><div class="tp-bar-fill" style="width:' +
          pct +
          '%"></div></div></td>' +
          '<td><span style="font-family:var(--mono);font-size:.68rem;color:var(--blue)">' +
          escHtml(p.category) +
          "</span></td>" +
