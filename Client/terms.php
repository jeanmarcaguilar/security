  ...
  <style>
    ...
    *::after {
    ...
    .terms-hero {
      ...
      border: 1px solid rgba(59, 139, 255, .12);
      border-radius: 14px;
    ...
    .terms-hero-icon {
      ...
      font-size: 1.5rem;
      flex-shrink: 0;
      box-shadow: 0 0 20px rgba(59, 139, 255, .3)
    }
      ...
      <div class="content">
        <div class="terms-wrap">
          ...
          <div class="terms-card">
            ...
            <p>Welcome to CyberShield, a vendor cybersecurity hygiene assessment platform. By accessing or using our
              platform, you agree to be bound by these Terms of Service and our Privacy Policy. If you do not agree to
              these terms, please do not use our services.</p>
            <p>CyberShield helps organizations evaluate their cybersecurity awareness and practices through standardized
              assessments, provides actionable insights, and tracks progress over time.</p>
          </div>
          ...
          <div class="terms-card">
            ...
            <p>All data is stored in a secure MySQL database hosted on our servers. We implement industry-standard
              security measures including:</p>
            <ul>
            ...
            <p>Your data is never sold to third parties. We only share data when required by law or with your explicit
              consent.</p>
          </div>
          ...
          <div class="terms-card">
            ...
            <p>To exercise these rights, contact your system administrator or email <a
                href="mailto:privacy@cybershield.ph">privacy@cybershield.ph</a>.</p>
          </div>
          ...
          <div class="terms-card">
            ...
            <p>The platform is provided "as is" without warranties of any kind. While we strive for accuracy, we do not
              guarantee that:</p>
            <ul>
          ...
          <div class="terms-card">
            ...
            <p>To the maximum extent permitted by law, CyberShield shall not be liable for any indirect, incidental,
          ...
          <div class="terms-card">
            ...
            <p>We may update these terms periodically. Significant changes will be notified via email or platform
              notification. Continued use of the platform after changes constitutes acceptance of the new terms.</p>
          ...
          <div class="acceptance-bar">
            <p>By using CyberShield, you acknowledge that you have read, understood, and agree to these Terms of Service
