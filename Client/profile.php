...
.audit-item{display:flex;align-items:flex-start;gap:.75rem;padding:.7rem 0;border-bottom:1px solid var(--border);transition:background .2s}
.audit-item:last-child{border-bottom:none}
.audit-item:hover{background:rgba(255,255,255,.02);margin:0 -0.5rem;padding:.7rem .5rem}
.audit-icon{width:28px;height:28px;border-radius:7px;display:flex;align-items:center;justify-content:center;flex-shrink:0;font-size:.9rem}
.audit-content{flex:1;min-width:0}
.audit-title{font-size:.8rem;font-weight:600;margin-bottom:.2rem}
.audit-desc{font-size:.72rem;color:var(--muted2);word-break:break-word}
.audit-meta{display:flex;gap:.75rem;margin-top:.3rem;font-size:.6rem;font-family:var(--mono);color:var(--muted)}
.audit-time{display:flex;align-items:center;gap:.25rem}
.info-chip{display:inline-flex;align-items:center;gap:.3rem;padding:.15rem .5rem;background:rgba(255,255,255,.05);border-radius:12px;font-size:.6rem}
.member-since{display:flex;align-items:center;gap:.5rem;margin-top:.5rem;padding-top:.5rem;border-top:1px solid var(--border);font-size:.72rem;color:var(--muted2)}
...
<div id="app">
  ...
  <aside id="sidebar">
    <div class="sb-brand">
      <div class="shield"><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2.2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></div>
      <div class="sb-brand-text"><h2>CyberShield</h2><span class="badge">Vendor Portal</span></div>
      <button class="sb-toggle" onclick="toggleSidebar()"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"><polyline points="15 18 9 12 15 6"/></svg></button>
    </div>
    <div class="sb-section">
      ...
      <a class="sb-item" href="assessment.php"><span class="sb-icon"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg></span><span class="sb-text">Take Assessment</span></a>
      <a class="sb-item" href="result.php"><span class="sb-icon"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg></span><span class="sb-text">My Results</span></a>
      <a class="sb-item" href="review.php"><span class="sb-icon"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="M8 6l4-4 4 4"/><path d="M12 2v13"/><path d="M20 21H4"/><path d="M17 12h3v9"/><path d="M4 12h3v9"/></svg></span><span class="sb-text">Review</span></a>
      <a class="sb-item" href="certificates.php"><span class="sb-icon"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><circle cx="12" cy="8" r="6"/><path d="M15.477 12.89L17 22l-5-3-5 3 1.523-9.11"/></svg></span><span class="sb-text">Certificates</span></a>
      <div class="sb-divider"></div>
      <div class="sb-label">Account</div>
      <a class="sb-item active" href="profile.php"><span class="sb-icon"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg></span><span class="sb-text">My Profile</span></a>
    ...
    <div class="topbar">
      ...
      <div class="tb-right">
        <div class="tb-search-wrap">
          ...
          <input type="text" class="tb-search" placeholder="Search assessments, tips…" autocomplete="off" id="global-search" onkeyup="filterAuditTrail()"/>
        </div>
        <span class="tb-date" id="tb-date"></span>
        <div class="tb-divider"></div>
        <button class="tb-icon-btn" onclick="toggleTheme()" title="Toggle theme">
          <svg id="tmoon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 21 12.79z"/></svg>
        ...
        <div class="notif-wrap">
          ...
          <div class="np hidden" id="np">
            ...
            <div id="np-list"><p class="np-empty">No notifications</p></div>
          </div>
        </div>
        <div class="tb-divider"></div>
        ...
        <div>
          ...
          <div class="card">
            ...
            <div class="fg">
              ...
              <input class="fi" type="email" id="profile-email" placeholder="your.email@example.com" value="<?php echo htmlspecialchars($user['email']); ?>">
            </div>
            <div class="fg">
        ...
        <div>
          ...
          <div class="card">
            ...
            <div class="stats-grid">
              <div class="stat-card" style="--accent:var(--blue)"><div class="stat-val"><?php echo $stats['total_assessments'] ?? 0; ?></div><div class="stat-lbl">Assessments</div></div>
              <div class="stat-card" style="--accent:var(--teal)"><div class="stat-val"><?php echo round($stats['avg_score'] ?? 0, 1); ?>%</div><div class="stat-lbl">Avg Score</div></div>
              <div class="stat-card" style="--accent:var(--green)"><div class="stat-val"><?php echo $stats['best_score'] ?? 0; ?>%</div><div class="stat-lbl">Best Score</div></div>
              <div class="stat-card" style="--accent:var(--purple)"><div class="stat-val"><?php echo $stats['latest_score'] ?? 'N/A'; ?><?php echo $stats['latest_score'] ? '%' : ''; ?></div><div class="stat-lbl">Latest Score</div></div>
            </div>
            <?php if ($stats['latest_rank']): ?>
            <div class="rank-display">Current Risk Level:&nbsp;<span class="rank r<?php echo $stats['latest_rank']; ?>"><?php echo $stats['latest_rank']; ?></span></div>
            <?php endif; ?>
            <div class="member-since"><span>📅 Member since</span><strong><?php echo date('F j, Y', strtotime($account_created)); ?></strong></div>
            <?php if ($last_login): ?><div class="member-since" style="margin-top:0.3rem;border-top:none;padding-top:0;"><span>🕒 Last login</span><strong><?php echo date('M j, g:i A', strtotime($last_login['created_at'])); ?></strong></div><?php endif; ?>
          </div>
          ...
          <div class="card">
            ...
            <div class="audit-timeline" id="audit-timeline">
              <?php if (count($audit_logs) > 0): ?>
                ...
                <div class="audit-item" data-search="<?php echo strtolower($log['action_description'] . ' ' . $log['action_display']); ?>">
                  <div class="audit-icon" style="background:<?php echo $log['action_color']; ?>20; border:1px solid <?php echo $log['action_color']; ?>40"><?php echo $log['action_display'][0]; ?></div>
                  <div class="audit-content">
                    <div class="audit-title" style="color:<?php echo $log['action_color']; ?>"><?php echo htmlspecialchars($log['action_display']); ?></div>
                ...
                <?php endforeach; ?>
              <?php else: ?>
                <div style="text-align:center;padding:2rem;color:var(--muted2);"><span>📭</span><p style="margin-top:.5rem">No audit records found yet.<br>Your activities will appear here.</p></div>
              <?php endif; ?>
            </div>
            <?php if (count($audit_logs) >= 15): ?>
            <div style="margin-top:.75rem;text-align:center"><span class="info-chip">Showing last 15 activities</span></div>
            <?php endif; ?>
          </div>
...
<div id="modal-overlay" class="mo hidden" onclick="if(event.target===this)closeModal()">
  <div class="modal">
    <div class="mhdr"><h3 id="modal-title">Confirm Action</h3><button class="mcl" onclick="closeModal()"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg></button></div>
    <div class="mbdy" id="modal-body">
      ...
      <div style="display:flex;gap:.5rem;margin-top:1rem"><button class="btn btn-d" onclick="confirmClearData()">Yes, Clear All</button><button class="btn btn-s" onclick="closeModal()">Cancel</button></div>
    </div>
  </div>
</div>
