...
<head>
    ...
    <style>
        ...
        * {
        ...
        .risk-moderate {
            background: rgba(59, 139, 255, 0.15);
            border-left: 4px solid #3B8BFF;
        }

        .risk-low {
            background: rgba(16, 217, 130, 0.15);
            border-left: 4px solid #10D982;
        }
        ...
        .ai-badge {
            ...
            align-items: center;
            gap: 0.5rem;
            background: linear-gradient(135deg, rgba(59, 139, 255, 0.2), rgba(123, 114, 240, 0.2));
        ...
        .chat-msg {
            animation: msgSlideIn .28s ease both;
        }
...
<body>
        ...
        <aside id="sidebar">
            ...
            <div class="sb-section">
                ...
                <a class="sb-item" href="index.php">
                    <span class="sb-icon"><svg width="15" height="15" viewBox="0 0 24 24" fill="none"
            ...
            <div class="sb-footer">
                ...
                <button class="btn-sb-logout" onclick="doLogout()">
                    <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <path
                            d="M9.5 2.5L12 5L14.5 2.5L17 5L19.5 2.5L21 5V16L18.5 18.5L16 21L12 19L8 21L5.5 18.5L3 16V5L4.5 2.5L7 5L9.5 2.5Z" />
                ...
                <div class="tb-right">
                    ...
                    <a class="tb-admin" href="profile.php">
                        ...
                        <div class="tb-admin-info">
                            <span
                                class="tb-admin-name"><?php echo htmlspecialchars($user['full_name'] ?? $user['username'] ?? 'User'); ?></span>
                            <span class="tb-admin-role">Client</span>
                        </div>
                        <svg width="10" height="10" viewBox="0 0 16 16" fill="none" stroke="currentColor"
                            stroke-width="1.8" style="color:var(--muted);margin-left:.2rem">
                            <path d="M4 6l4 4 4-4" />
                        </svg>
                    </a>
                </div>
                ...
                <?php if ($no_assessment): ?>
                    <div class="results-card fade-in">
                        <div style="text-align: center; padding: 3rem;">
                            ...
                            <p style="color: var(--muted2); margin-bottom: 2rem;">Take your first assessment to see your
                                security score and personalized AI recommendations.</p>
                        ...
                        <div class="score-category-container">
                            ...
                            <div class="score-section">
                                ...
                                <div class="rank-badge-large"
                                    style="color: <?php echo $rankDetails['color']; ?>; text-align: center;">
                                    Rank <?php echo $rankDetails['letter']; ?>
                                </div>
                                <h2 class="result-title"><?php echo $rankDetails['title']; ?>
                                    <?php echo $rankDetails['icon']; ?></h2>
                            ...
                            <div class="category-section">
                                ...
                                <?php if ($aiInsights): ?>
                                    <div class="encouragement-small">
                                        ...
                                        <span
                                            class="encouragement-text-small"><?php echo htmlspecialchars($aiInsights['encouragement']); ?></span>
                                        <span class="encouragement-icon-small">✨</span>
                                    </div>
                                <?php endif; ?>
                                    ...
                                    foreach ($categoryList as $key => $cat):
                                        ...
                                        <div class="category-row">
                                            <div class="category-info">
                                                <div class="category-icon" style="background: <?php echo $scoreColor; ?>20;">
                                                    <?php echo $cat['icon']; ?></div>
                                                <span class="category-name"><?php echo $cat['name']; ?></span>
                                                <div class="progress-bar-mini">
                                                    <div class="progress-fill-mini"
                                                        style="width: <?php echo $catScore; ?>%; background: <?php echo $scoreColor; ?>;">
                                                    </div>
                                                </div>
                                            </div>
                                            <span class="category-score"
                                                style="color: <?php echo $scoreColor; ?>;"><?php echo $catScore; ?>%</span>
                                        </div>
                                    <?php endforeach; ?>
                                </div>
                            </div>
                        ...
                        <div class="ai-section">
                            <div
                                ...
                                <div style="display: flex; align-items: center; gap: 0.75rem;">
                                    <div
                                        style="background: linear-gradient(135deg, rgba(59,139,255,0.2), rgba(123,114,240,0.2)); padding: 0.5rem; border-radius: 12px;">
                                ...
                                <button onclick="refreshAIInsights()" class="btn-secondary"
                         ...
                         ═══════════════════════════════════════════════════════ -->
                                <div class="risk-banner risk-<?php echo $aiInsights['risk_level']; ?>" id="ai-risk-banner"
                                    style="position:relative;overflow:hidden;">

                                    <!-- Animated risk icon -->
                                    <span style="font-size:2.2rem;flex-shrink:0;animation:riskPulse 2s ease-in-out infinite;"
                                        id="risk-icon-el">
                                    ...
                                    <div style="flex:1;">
                                        <!-- Title row -->
                                        <div
                                            style="display:flex;align-items:center;gap:.75rem;flex-wrap:wrap;margin-bottom:.4rem;">
                                            ...
                                            <span
                                                style="display:inline-flex;align-items:center;gap:.3rem;background:rgba(59,139,255,.12);border:1px solid rgba(59,139,255,.2);padding:.15rem .6rem;border-radius:20px;font-size:.62rem;font-family:var(--mono);color:var(--blue);">
                                        ...
                                        <div style="display:flex;align-items:center;gap:1.2rem;margin:.5rem 0;flex-wrap:wrap;">
                                            <div style="display:flex;align-items:baseline;gap:.2rem;">
                                                <span style="font-family:var(--mono);font-size:.8rem;color:var(--muted2);">Risk
                                                    Score:</span>
                                                &nbsp;
                                            ...
                                            <div style="flex:1;min-width:140px;">
                                                <div
                                                    style="display:flex;justify-content:space-between;font-family:var(--mono);font-size:.58rem;color:var(--muted);margin-bottom:.3rem;">
                                                    <span>Low Risk (0)</span><span>Critical (100)</span>
                                                </div>
                                                <div
                                                    style="height:10px;background:rgba(255,255,255,.07);border-radius:5px;overflow:hidden;">
                                ...
                                <div style="margin-bottom: 1.5rem;">
                                    ...
                                    <div
                                        style="background: var(--bg2); padding: 1rem; border-radius: 12px; border: 1px solid var(--border);">
                                        <p style="line-height: 1.6; font-size: 0.95rem;">
                                            <?php echo htmlspecialchars($aiInsights['executive_summary']); ?></p>
                                    </div>
                                </div>
                                        ...
                                        <div style="display: flex; flex-direction: column; gap: 0.75rem;">
                                            <?php foreach ($aiInsights['advice'] as $advice): ?>
                                                <div class="advice-item">
                                                    ...
                                                    <span
                                                        style="font-size: 0.9rem; line-height: 1.4;"><?php echo htmlspecialchars($advice); ?></span>
                                                </div>
                                            <?php endforeach; ?>
                                        </div>
                                    </div>
    ...
    " onmouseover="this.style.transform='scale(1.1)';this.style.boxShadow='0 6px 32px rgba(59,139,255,.75), 0 2px 12px rgba(0,0,0,.4)'"
                                    ...
                                    <svg id="cs-btn-icon-open" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                        <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" />
                                    </svg>
                                    <!-- X icon shown when open -->
                                    <svg id="cs-btn-icon-close" width="22" height="22" viewBox="0 0 24 24" fill="none"
...
">
                                    <span
                                        style="width:7px;height:7px;border-radius:50%;background:#10D982;animation:blink 2s ease-in-out infinite;flex-shrink:0;"></span>
...
">
    ...
    ">
                                        <div
                                            style="width:36px;height:36px;background:linear-gradient(135deg,var(--blue,#3B8BFF),var(--purple,#8B5CF6));border-radius:10px;display:flex;align-items:center;justify-content:center;flex-shrink:0;box-shadow:0 0 12px rgba(59,139,255,.4);">
                                        ...
                                        <div style="flex:1;min-width:0;">
                                            <div
                                                style="font-family:var(--display,'sans-serif');font-size:.88rem;font-weight:700;color:var(--text,#e0e6f0);">
                                                CyberShield AI Assistant</div>
                                            <div
                                                style="font-size:.62rem;color:var(--muted2,'#8899aa');white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">
                                                Score: <strong
                                                    style="color:var(--text,#e0e6f0);"><?php echo $score; ?>%</strong>
                                                &nbsp;·&nbsp; Risk: <strong
                                                    style="color:<?php echo $aiInsights['risk_color']; ?>;"><?php echo ucfirst($aiInsights['risk_level']); ?>
                                                    (<?php echo $aiInsights['risk_score']; ?>/100)</strong>
                                            </div>
                                        </div>
                                        <div style="display:flex;align-items:center;gap:.3rem;flex-shrink:0;">
                                            <div
                                                style="width:7px;height:7px;border-radius:50%;background:var(--green,#10D982);animation:blink 2s ease-in-out infinite;">
                                            </div>
                                            <span
                                                style="font-family:var(--mono,'monospace');font-size:.58rem;color:var(--green,#10D982);">Online</span>
                                        </div>
                                        <button onclick="toggleChatPopup()"
                                            style="background:none;border:none;cursor:pointer;color:var(--muted2,'#8899aa');padding:.2rem;border-radius:6px;display:flex;transition:color .15s;"
                                            onmouseover="this.style.color='var(--text,#e0e6f0)'"
                                            onmouseout="this.style.color='var(--muted2,#8899aa)'">
    ...
    ">
                                        ...
                                        <div class="chat-msg assistant"
                                            style="display:flex;gap:.5rem;align-items:flex-start;animation:msgSlideIn .28s ease both;">
                                            <div
                                                style="width:26px;height:26px;border-radius:8px;background:linear-gradient(135deg,var(--blue,#3B8BFF),var(--purple,#8B5CF6));color:#fff;display:flex;align-items:center;justify-content:center;font-size:.68rem;flex-shrink:0;">
                                                🤖</div>
                                            <div>
                                                <div
                                                    style="background:var(--card-bg,#111318);border:1px solid var(--border,#1e2330);border-radius:10px 10px 10px 3px;padding:.55rem .8rem;font-size:.79rem;line-height:1.55;max-width:260px;color:var(--text,#e0e6f0);">
                                                    <?php
                                                ...
                                                <div
                                                    style="font-family:var(--mono,'monospace');font-size:.56rem;color:var(--muted,'#5a6478');margin-top:.2rem;">
                                                    <?php echo date('g:i A'); ?></div>
                                            </div>
                                        </div>
                                        <!-- Typing indicator -->
                                        <div id="chat-typing" style="display:none;gap:.5rem;align-items:center;">
                                            <div
                                                ...
                                                🤖</div>
                                            <div
                                                style="background:var(--card-bg,#111318);border:1px solid var(--border,#1e2330);border-radius:10px 10px 10px 3px;padding:.55rem .85rem;display:flex;gap:.28rem;align-items:center;">
                                                <div class="typing-dot"
                                                    style="width:6px;height:6px;border-radius:50%;background:var(--muted2,'#8899aa');animation:typingBounce 1.4s ease-in-out infinite;">
                                                </div>
                                                <div class="typing-dot"
                                                    style="width:6px;height:6px;border-radius:50%;background:var(--muted2,'#8899aa');animation:typingBounce 1.4s ease-in-out .2s infinite;">
                                                </div>
                                                <div class="typing-dot"
                                                    style="width:6px;height:6px;border-radius:50%;background:var(--muted2,'#8899aa');animation:typingBounce 1.4s ease-in-out .4s infinite;">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div
                                        style="padding:.5rem .85rem .4rem;display:flex;gap:.32rem;flex-wrap:wrap;border-top:1px solid var(--border,#1e2330);background:var(--bg,#0d0f14);">
                                        <?php
                                        $chips = [
                                    ...
                                    <!-- Chat input -->
                                    <div
                                        style="padding:.6rem .75rem .75rem;background:var(--card-bg,#111318);display:flex;gap:.5rem;border-top:1px solid var(--border,#1e2330);">
                            ...
                            <div class="videos-grid">
                                <?php foreach ($recommendedVideos as $index => $video):
                                    ...
                                    <div class="video-card-enhanced"
                                        onclick="playVideo('<?php echo htmlspecialchars($video['title'], ENT_QUOTES); ?>', '<?php echo $videoUrl; ?>')">
                                        <div class="video-thumb-enhanced">
                                            ...
                                            <?php if ($video['priority'] !== 'low'): ?>
                                                <div class="priority-badge <?php echo $video['priority']; ?>"
                                                    style="background: <?php echo $priorityColor; ?>;"><?php echo $priorityLabel; ?>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                        <div class="video-info-enhanced">
                                            ...
                                            <h5 class="video-title-enhanced"><?php echo htmlspecialchars($video['title']); ?>
                                            </h5>
                                            <p class="video-desc-enhanced">
                                                <?php echo htmlspecialchars($video['description']); ?></p>
    ...
    <div id="videoModal" class="video-modal">
        <div class="video-modal-content">
            ...
            <div class="video-modal-body">
                <iframe id="videoIframe" class="video-modal-iframe" src="" allowfullscreen
