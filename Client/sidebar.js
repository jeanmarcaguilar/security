...
showPage = function (name) {
  ...
  if (name === "seller-analytics") {
    ...
    if (pg2) {
      ...
      pg2.classList.remove("fade-in");
      void pg2.offsetWidth;
      pg2.classList.add("fade-in");
    }
    setTimeout(function () {
...
var ALL_TIPS = [
  {
    ...
    body: "A password manager creates and remembers strong, unique passwords for every website so you never have to. Recommended: Bitwarden (free) or 1Password.",
    difficulty: "Easy",
  },
  {
    cat: "password",
    title: "Enable Two-Factor Authentication",
    body: "Even if your password is stolen, attackers still cannot log in without a second verification step. Enable this on email, banking, and work accounts first.",
    difficulty: "Easy",
  },
  {
    cat: "password",
    title: "Create Long, Unique Passwords",
    body: 'Use at least 12 characters and combine random words. For example, "PurpleElephant$42Rain" is far stronger than "P@ssword1" and easier to remember.',
    difficulty: "Easy",
  },
  {
    cat: "password",
    title: "Change Passwords After Breaches",
    body: "If a service you use reports a data breach, change your password immediately. Visit haveibeenpwned.com to check whether your email has appeared in known breaches.",
    difficulty: "Medium",
  },
  {
    cat: "phishing",
    title: "Verify Links Before Clicking",
    body: "Hover over any link in an email to preview the real web address before clicking. If the domain looks unfamiliar or misspelled, do not proceed.",
    difficulty: "Easy",
  },
  {
    cat: "phishing",
    title: "Call to Confirm Suspicious Requests",
    body: "If you receive an urgent email requesting passwords or payments, call the sender directly using a phone number you already know — never use a number provided in the suspicious email.",
    difficulty: "Easy",
  },
  {
    cat: "phishing",
    title: "Recognise Phishing Warning Signs",
    body: "Be cautious of emails with urgent language, spelling mistakes, mismatched sender addresses, unexpected attachments, or requests for sensitive personal information.",
    difficulty: "Easy",
  },
  {
    cat: "phishing",
    title: "Report Suspicious Emails",
    body: "Do not simply delete phishing emails — report them to your IT or security team. This helps protect your entire organization from similar attacks.",
    difficulty: "Easy",
  },
  {
    cat: "device",
    title: "Set Auto-Lock on Your Screen",
    body: "Configure your computer to lock automatically after 2–5 minutes of inactivity. On Windows go to Settings → Personalization → Lock Screen; on Mac, System Preferences → Security.",
    difficulty: "Easy",
  },
  {
    cat: "device",
    title: "Enable Full-Disk Encryption",
    body: "Encryption protects all data on your device if it is ever lost or stolen. Use BitLocker on Windows or FileVault on Mac — both are built-in and free to activate.",
    difficulty: "Medium",
  },
  {
    cat: "device",
    title: "Install Security Updates Promptly",
    body: "Apply operating system and application updates as soon as they are available. Most attacks target known vulnerabilities that updates have already fixed.",
    difficulty: "Easy",
  },
  {
    cat: "device",
    title: "Never Use Unknown USB Devices",
    body: "A USB drive found in a public place could be a deliberate trap. Inserting it can install malware automatically, even before you open any files.",
    difficulty: "Easy",
  },
  {
    cat: "network",
    title: "Use a VPN on Public Wi-Fi",
    body: "Public Wi-Fi at cafes, airports, and hotels is not secure. A VPN encrypts your connection so others on the same network cannot intercept your data.",
    difficulty: "Medium",
  },
  {
    cat: "network",
    title: "Look for HTTPS on Websites",
    body: 'Before entering passwords or payment details, verify the address begins with "https://" and shows a padlock icon. This confirms that your data is encrypted in transit.',
    difficulty: "Easy",
  },
  {
    cat: "network",
    title: "Disable Auto-Connect to Wi-Fi",
    body: 'Turn off automatic Wi-Fi connections on your devices. Attackers can create fake hotspots with names like "Airport Free WiFi" to intercept your traffic.',
    difficulty: "Easy",
  },
  {
    cat: "network",
    title: "Secure Your Home Router",
    body: "Change your router's default admin password, use WPA3 or WPA2 encryption, and keep the firmware updated to prevent unauthorised access to your network.",
    difficulty: "Medium",
  },
];
...
function renderTipsPage() {
  ...
  if (!grid) return;
  var list =
    _currentTipFilter === "all"
      ? ALL_TIPS
      : ALL_TIPS.filter(function (t) {
          return t.cat === _currentTipFilter;
        });
  grid.innerHTML = list
    .map(function (tip, i) {
      return (
        '<div class="tip-card-item" style="animation-delay:' +
        i * 0.05 +
        's">' +
        ...
        _difficultyLabel[tip.difficulty] +
        "</div>" +
        "</div>"
      );
    })
  ...
  ALL_TIPS.forEach(function (tip) {
    if (
      ...
      results.push({
        icon: null,
        title: tip.title,
        sub: "Security Tip · " + _catLabels[tip.cat],
        page: "tips",
      });
    }
  });
  ...
  list.innerHTML = results
    ...
    .map(function (r, i) {
      return (
        ...
        (r.icon || "●") +
        "</div>" +
        '<div><div class="search-result-title">' +
        r.title +
        "</div>" +
...
function updateSidebarUser() {
  ...
  if (window.session) {
    if (sAvatar)
      sAvatar.textContent = (session.name || "U").charAt(0).toUpperCase();
