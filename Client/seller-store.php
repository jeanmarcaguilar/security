  ...
  <style>
    ...
    *::after {
    ...
    .modal-overlay .modal-panel {
      ...
      max-height: 90vh;
      overflow-y: auto;
      box-shadow: 0 32px 100px rgba(0, 0, 0, .75), 0 0 0 1px rgba(255, 255, 255, .04);
    ...
    .mpf-input:focus {
      border-color: rgba(59, 139, 255, .5);
      box-shadow: 0 0 0 3px rgba(59, 139, 255, .1)
    }

    .mpf-input::placeholder {
      color: var(--muted)
    }
  ...
  <div id="app">
    ...
    <div id="sidebar">
      ...
      <div class="sb-section">
        ...
        <a class="sb-item active" href="seller-store.php"><span class="sb-icon"><svg width="15" height="15"
        ...
        <a class="sb-item active" href="terms.php"><span class="sb-icon"><svg width="15" height="15" viewBox="0 0 24 24"
              fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round">
      ...
      <div class="sb-footer">
        <div class="sb-user">
          <div class="sb-avatar"><?php echo strtoupper(substr($user['full_name'] ?? $user['username'] ?? 'U', 0, 1)); ?>
          </div>
      ...
      <div class="topbar">
        ...
        <div class="tb-right">
          <div class="tb-search-wrap">
            <svg class="tb-search-icon" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor"
              stroke-width="1.7">
          ...
          <div class="tb-admin" onclick="window.location.href='profile.php'">
            <div class="tb-admin-av">
              <?php echo strtoupper(substr($user['full_name'] ?? $user['username'] ?? 'U', 0, 1)); ?></div>
            <div class="tb-admin-info">
              <div class="tb-admin-name">
                <?php echo htmlspecialchars($user['full_name'] ?? $user['username'] ?? 'User'); ?></div>
        ...
        <div class="page-inner fade-in">
          ...
          <div class="store-hero">
            <div class="hero-content" style="width:100%">
              <h1
                style="margin-bottom: 0.5rem; font-size: 2.5rem; font-weight: 800; background: linear-gradient(135deg, #3B8BFF, #7B72F0); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;">
                My Store</h1>
          ...
          <div class="stats-grid enhanced">
            <div class="stat-card enhanced">
              ...
              <div class="stat-trend">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#10D982" stroke-width="2">
            ...
            <div class="stat-card enhanced">
              ...
              <div class="stat-trend">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#F5B731" stroke-width="2">
                  <polyline points="23 18 13.5 8.5 8.5 1 6" />
          ...
          <div class="filter-section">
            ...
            <div class="filter-buttons enhanced">
              ...
              <button class="filter-btn" onclick="filterProducts('active', this)">
                ...
                <span
                  class="filter-count"><?php echo count(array_filter($products, fn($p) => $p['status'] === 'active')); ?></span>
              </button>
              <button class="filter-btn" onclick="filterProducts('inactive', this)">
                <span class="filter-icon">⏸️</span>
                <span class="filter-text">Inactive</span>
                <span
                  class="filter-count"><?php echo count(array_filter($products, fn($p) => $p['status'] === 'inactive')); ?></span>
              </button>
              <button class="filter-btn" onclick="filterProducts('lowstock', this)">
                <span class="filter-icon">⚠️</span>
                <span class="filter-text">Low Stock</span>
                <span
                  class="filter-count"><?php echo count(array_filter($products, fn($p) => $p['stock'] < 10)); ?></span>
              </button>
            </div>
          </div>
        ...
        <div class="modal-panel-body">
          <form id="product-form" onsubmit="saveProduct(event)">
            ...
            <div class="mpf-group">
              ...
              <textarea id="product-desc" rows="3" class="mpf-input"
            ...
            <div class="mpf-row">
              <div class="mpf-group" style="margin-bottom:0">
                ...
                <input type="number" id="product-price" step="0.01" min="0" required class="mpf-input"
                  placeholder="0.00">
              </div>
              <div class="mpf-group" style="margin-bottom:0">
    ...
    <div id="logout-modal" class="mo hidden" onclick="if(event.target===this)closeLogoutModal()">
      <div class="modal">
        <div class="mhdr">
          <h3 id="logout-modal-title">Confirm Logout</h3><button class="mcl" onclick="closeLogoutModal()"><svg
