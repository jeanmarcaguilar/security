...
<head>
  ...
  <style>
    ...
    *::after {
    ...
    /* ── Hero Banner ── */
    .tips-hero {
      background: linear-gradient(135deg, rgba(59, 139, 255, .15), rgba(123, 114, 240, .15));
  ...
  <div id="app">
    ...
    <aside id="sidebar">
      ...
      <div class="sb-section">
        ...
        <a class="sb-item active" href="security-tips.php"><span class="sb-icon"><svg width="15" height="15"
    ...
    <div id="main">
      ...
      <div class="content">
        ...
        <div class="filter-bar">
          ...
          <span class="filter-chip" data-category="password" onclick="filterTips('password',this)">🔐 Password
            Security</span>
          <span class="filter-chip" data-category="phishing" onclick="filterTips('phishing',this)">🎣 Phishing
            Awareness</span>
          <span class="filter-chip" data-category="device" onclick="filterTips('device',this)">💻 Device Security</span>
          <span class="filter-chip" data-category="network" onclick="filterTips('network',this)">🌐 Network
            Security</span>
        </div>
        ...
        <div class="tips-grid" id="tips-grid">
          ...
          foreach ($tips as $tip):
            ...
            <div class="tip-card" data-category="<?php echo $tip['category']; ?>"
              style="--cat-color:<?php echo $color; ?>" onclick="showTipDetail(<?php echo $tip['id']; ?>)">
              <div class="tip-card-top">
                <span class="tip-icon"><?php echo $tip['icon']; ?></span>
                <span
                  class="cat-badge cat-<?php echo $tip['category']; ?>"><?php echo ucfirst($tip['category']); ?></span>
              </div>
              ...
              <div class="tip-more">Read more <svg width="10" height="10" viewBox="0 0 16 16" fill="none"
