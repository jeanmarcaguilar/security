  ...
  <style>
    ...
    *::after {
    ...
    .analytics-hero::before {
      ...
      position: absolute;
      inset: 0;
      background: radial-gradient(circle at 15% 80%, rgba(59, 139, 255, .07) 0%, transparent 50%), radial-gradient(circle at 85% 20%, rgba(123, 114, 240, .07) 0%, transparent 50%);
      pointer-events: none
    }
    ...
    .inv-alert.ok {
      background: rgba(16, 217, 130, .05);
      border: 1px solid rgba(16, 217, 130, .18)
    }
  ...
  <div id="app">
    ...
    <div id="sidebar">
      ...
      <div class="sb-section">
        ...
        <a class="sb-item active" href="seller-analytics.php"><span class="sb-icon"><svg width="15" height="15"
        ...
        <div class="page-inner fade-in">
          ...
          <div class="kpi-grid">
            <div class="kpi-card" style="--accent:var(--blue)">
              <div class="kpi-top">
                <div class="kpi-icon">
                  <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="var(--blue)" stroke-width="1.9"
                    stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="kpi-card" style="--accent:var(--green)">
              <div class="kpi-top">
                <div class="kpi-icon" style="background:rgba(16,217,130,.08)">
                  <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="var(--green)" stroke-width="1.9"
                    stroke-linecap="round" stroke-linejoin="round">
                    <path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z" />
                    <line x1="3" y1="6" x2="21" y2="6" />
                  </svg>
            ...
            <div class="kpi-card" style="--accent:var(--purple)">
              <div class="kpi-top">
                <div class="kpi-icon" style="background:rgba(123,114,240,.08)">
                  <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="var(--purple)" stroke-width="1.9"
                    stroke-linecap="round" stroke-linejoin="round">
                    <line x1="12" y1="20" x2="12" y2="4" />
                    <line x1="18" y1="20" x2="18" y2="10" />
                    <line x1="6" y1="20" x2="6" y2="14" />
            ...
            <div class="kpi-card" style="--accent:var(--<?php echo $lowStockCount > 0 ? 'red' : 'green'; ?>)">
              <div class="kpi-top">
                <div class="kpi-icon"
                  style="background:rgba(<?php echo $lowStockCount > 0 ? '255,59,92' : '16,217,130'; ?>,.08)">
                  <svg width="17" height="17" viewBox="0 0 24 24" fill="none"
                    stroke="var(--<?php echo $lowStockCount > 0 ? 'red' : 'green'; ?>)" stroke-width="1.9"
                    stroke-linecap="round" stroke-linejoin="round">
                    <path
                ...
                <span
                  class="kpi-badge <?php echo $lowStockCount > 0 ? 'badge-down' : 'badge-up'; ?>"><?php echo $lowStockCount > 0 ? 'restock' : 'all ok'; ?></span>
              </div>
          ...
          <div class="chart-card" style="margin-bottom:2rem">
            ...
            <div class="chart-wrap" style="height:<?php echo max(180, count($products) * 38); ?>px"><canvas
                id="stock-chart"></canvas></div>
          </div>
  ...
  <script>
    ...
    function buildStockChart() {
      ...
      stockChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: products.map(p => p.name.length > 18 ? p.name.substring(0, 18) + '…' : p.name),
