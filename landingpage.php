...
.btn-submit:hover:not(:disabled) { transform: translateY(-2px); box-shadow: 0 8px 40px rgba(59,139,255,0.45); }
.btn-submit:hover:not(:disabled)::before { opacity: 1; }
.btn-submit:active { transform: none; }
.btn-submit:disabled { opacity: 0.5; cursor: not-allowed; }
.submit-arrow { transition: transform 0.2s; }
.btn-submit:hover:not(:disabled) .submit-arrow { transform: translateX(4px); }
.status-bar {
...
.auth-tab {
flex: 1; padding: 11px 0; text-align: center; border-radius: 8px;
...
.auth-tab.active {
background: rgba(59,139,255,0.15); color: var(--blue);
...
.btn-signup-submit:hover:not(:disabled) { box-shadow: 0 8px 40px rgba(0,201,122,0.4); }
/* ═══ IMAGE CAPTCHA ═══ */
.captcha-wrap {
display: none;
...
.captcha-wrap.visible { display: flex; }
.captcha-header {
font-family: 'JetBrains Mono', monospace; font-size: 9px;
letter-spacing: 2px; color: var(--dim); text-transform: uppercase;
display: flex; align-items: center; gap: 6px;
}
.captcha-header::before { content: '//'; color: var(--blue); font-size: 11px; }
.captcha-instruction {
font-size: 13px;
color: var(--text);
font-weight: 500;
...
letter-spacing: 1px; display: none; padding: 8px 12px;
border-radius: 6px;
}
...
background: rgba(3, 5, 8, 0.95); backdrop-filter: blur(8px);
...
background: #0a0e17; border: 1px solid rgba(59, 139, 255, 0.2);
...
.modal-title {
font-family: 'Bebas Neue', sans-serif; font-size: 32px; text-align: center;
margin-bottom: 8px;
...
.modal-subtitle strong { color: var(--blue); font-weight: 500; }
.otp-input-group {
...
font-size: 28px; font-weight: 600; color: var(--text); text-align: center;
outline: none; transition: all 0.2s;
}
.otp-digit:focus { border-color: var(--blue); background: rgba(59, 139, 255, 0.05); box-shadow: 0 0 0 3px rgba(59, 139, 255, 0.1); }
.otp-timer {
text-align: center; font-family: 'JetBrains Mono', monospace; font-size: 12px;
color: var(--muted); margin-bottom: 20px; padding: 8px;
background: rgba(0, 255, 148, 0.05); border: 1px solid rgba(0, 255, 148, 0.1); border-radius: 8px;
}
.otp-timer.expiring { color: var(--red); border-color: rgba(255, 59, 92, 0.3); }
...
.otp-btn-primary { background: linear-gradient(135deg, var(--blue), #5b6fff); color: white; box-shadow: 0 4px 20px rgba(59, 139, 255, 0.3); }
.otp-btn-primary:hover:not(:disabled) { transform: translateY(-2px); box-shadow: 0 8px 30px rgba(59, 139, 255, 0.4); }
.otp-btn-secondary { background: transparent; border: 1px solid rgba(255, 255, 255, 0.1); color: var(--muted); }
.otp-btn-secondary:hover:not(:disabled) { border-color: var(--blue); color: var(--blue); background: rgba(59, 139, 255, 0.05); }
.otp-btn:disabled { opacity: 0.4; cursor: not-allowed; transform: none !important; }
.modal-close {
position: absolute; top: 20px; right: 20px;
width: 32px; height: 32px; border-radius: 50%;
background: rgba(255, 255, 255, 0.03); border: 1px solid rgba(255, 255, 255, 0.08);
color: var(--muted); display: flex; align-items: center; justify-content: center;
cursor: pointer; transition: all 0.2s; font-size: 16px; z-index: 2;
}
.modal-close:hover { border-color: var(--red); color: var(--red); background: rgba(255, 59, 92, 0.05); }
.otp-info {
display: flex; align-items: center; gap: 8px; margin-top: 16px; padding: 12px;
background: rgba(59, 139, 255, 0.05); border: 1px solid rgba(59, 139, 255, 0.1);
border-radius: 8px; font-size: 11px; color: var(--muted);
font-family: 'JetBrains Mono', monospace;
}
.otp-info-icon { color: var(--blue); font-size: 14px; }
...
.stat { min-width: 50%; }
.modal-container { margin: 20px; padding: 24px; }
.otp-digit { width: 45px; height: 54px; font-size: 24px; }
.captcha-square { font-size: 32px; }
}
</style>
</head>
<body>
...
<button type="button" class="captcha-verify-btn" id="captchaVerifyBtn" onclick="verifyImageCaptcha()" disabled>
Verify Selection
</button>
</div>
